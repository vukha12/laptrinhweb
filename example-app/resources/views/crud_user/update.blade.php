        ...
        <div class="border border-black border-1 p-4">
            ...
            <form action="{{ route('user.postUpdateUser') }}" method="POST">
                ...
                <div class="form-group pb-4 ps-4 pe-4">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="{{ $user->name}}" require autofocus />
                </div>

                <div class="form-group pb-4 ps-4 pe-4">
                    <label class="fs-6" for="pwd">Email:</label>
                    <input type="text" class="form-control" id="email" name="email" value="{{ $user->email}}" require autofocus />
                </div>
