        ...
        <div class="border border-black border-1">
            ...
            <form method='POST' action="<?php echo e(route('user.authUser')); ?>">
                ...
                <div class="form-group p-4">
                    <label class="fs-6" for="email">Username:</label>
                    <input type="text" placeholder="Email" id="email" class="form-control" name="email" require autofocus />
                </div>

                <div class="form-group pb-4 ps-4 pe-4">
                    <label class="fs-6" for="pwd">Mật khẩu:</label>
                    <input type="password" placeholder="Password" id="password" class="form-control" name="password" require />
                </div>
...
</html><?php /**PATH K:\1-TDC\2-backend\week_7\laravel_crud_user\laptrinhweb.git\example-app\resources\views/crud_user/login.blade.php ENDPATH**/ ?>